"""
Django settings for srcr project.
...
SECRET_KEY = 'django-insecure-suscj6e(3dbod!0&o37#+^znlkfvffw)3uti33mw$w-j_f1+sl'
...
WSGI_APPLICATION = 'srcr.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'srcr_db_teschi',                      # Nombre de la base de datos
        'USER': 'srcr_db_teschi_user',                 # Usuario de la base de datos
        'PASSWORD': 'kVMGroziYn5dFL0m3ZanPBhMqVjyYiyA',  # Contraseña del usuario 
        'HOST': 'dpg-d5j65856ubrc73ehfnt0-a.oregon-postgres.render.com',  # Host del servidor PostgreSQL
        'PORT': '5432',
        'OPTIONS': {
